...
But this is only available for SSR (Server Side Rendering) mode. Static mode still not working, you can see the issue [https://github.com/nuxt/content/issues/1202](https://github.com/nuxt/content/issues/1202)
